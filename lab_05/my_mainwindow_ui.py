...
#         if len(self.sp == 0):
#             self.sp.append([e.scenePos().x(), e.scenePos().y()])
#         else:
#             point =  e.scenePos()
#             x, y = point.x(), point.y()

#             point =  e.lastScenePos()
#             x1, y1 = point.x(), point.y()
#             self.addLine(x, y, x + 500, y, self.pen)
#             sp.append()
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView.setGeometry(QtCore.QRect(300, 0, 971, 891))
        ...
        self.but_color_edge.setGeometry(QtCore.QRect(90, 10, 91, 71))
        font = QtGui.QFont()
        ...
        self.line_x.setGeometry(QtCore.QRect(60, 560, 121, 21))
        font = QtGui.QFont()
        ...
        self.but_color_bg.setGeometry(QtCore.QRect(90, 90, 91, 71))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.but_color_edge_def.setGeometry(QtCore.QRect(190, 10, 101, 71))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.color_ind_bg.setGeometry(QtCore.QRect(10, 90, 71, 71))
        ...
        self.but_color_bg_def.setGeometry(QtCore.QRect(190, 90, 101, 71))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.color_ind_fill.setGeometry(QtCore.QRect(10, 170, 71, 71))
        ...
        self.but_color_fill.setGeometry(QtCore.QRect(90, 170, 91, 71))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.but_color_fill_def.setGeometry(QtCore.QRect(190, 170, 101, 71))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.lab_x.setGeometry(QtCore.QRect(10, 560, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lab_y.setGeometry(QtCore.QRect(10, 590, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.line_y.setGeometry(QtCore.QRect(60, 590, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.but_add_dot.setGeometry(QtCore.QRect(190, 560, 101, 51))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.lab_centre_5.setGeometry(QtCore.QRect(0, 670, 301, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.but_bg_to_fill = QtWidgets.QPushButton(self.centralwidget)
        self.but_bg_to_fill.setGeometry(QtCore.QRect(10, 250, 271, 51))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.but_bg_to_fill.setFont(font)
        self.but_bg_to_fill.setObjectName("but_bg_to_fill")
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(10, 360, 271, 192))
...
"добавить горизонтальную линию"))
        ...
        self.lab_centre_6.setText(_translate("MainWindow", "Для изменения цвета контура и фона\n"
"необходимо очистить экран"))
        self.but_bg_to_fill.setText(_translate("MainWindow", "Выбрать цвет фона как\n"
"цвет закраски"))
